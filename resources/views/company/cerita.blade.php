...
@section('title','Bagaimana kami memulai dan inilah cerita kami')
@section('metadesc','Temukan bagaimana kami memulai ini semua. Baca sejarah dan cerita kami bagaimana proses terjadinya
sarjanamalam sejak Bintang Tobing menemukan ini ditahun 2019')
@section('metakey','cerita sarjanamalam, sejarah sarjanamalam')
@section('content')
<section class="storiesimg">
    <div class="container">
        <div class="page-title">
            <h1>Cerita kami</h1>
            <span>Bagaimana kami memulai dan inilah cerita kami</span>
        </div>
    </div>
</section>
<section>
